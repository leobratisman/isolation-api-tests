...
from protos.gen.contracts.services.accounts.account_pb2 import Account, AccountType, AccountStatus
from protos.gen.contracts.services.cards.card_pb2 import Card, CardType, CardStatus, CardPaymentSystem
